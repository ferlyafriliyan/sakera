...
ua_nokia   = 'NokiaC2-01/5.0 (11.20) Profile/MIDP-2.1 Configuration/CLDC-1.1 Mozilla/5.0 AppleWebKit/420+ (KHTML, like Gecko) Safari/420+'
ua_xiaomi  = 'Mozilla/5.0 (Linux; Android 10; Mi 9T Pro Build/QKQ1.190825.002; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/88.0.4324.181 Mobile Safari/537.36 [FBAN/EMA;FBLC/id_ID;FBAV/239.0.0.10.109;]'
ua_oppo    = 'Mozilla/5.0 (Linux; Android 5.1.1; A37f) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/89.0.4389.105 Mobile Safari/537.36 [FBAN/EMA;FBLC/id_ID;FBAV/239.0.0.10.109;]'
ua_vivo    = 'Mozilla/5.0 (Linux; Android 12; V2111 Build/SP1A.210812.003_NONFC; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/105.0.5195.136 Mobile Safari/537.36 Weibo (vivo-V2111__weibo__12.9.3__android__android12)'
ua_iphone  = 'Mozilla/5.0 (iPad; U; CPU OS 4_3 like Mac OS X; en-us) AppleWebKit/533.17.9 (KHTML, like Gecko) Mobile/8F191 [FBAN/FBIOS;FBAV/5.2.2;FBBV/82131;FBDV/iPad2,1;FBMD/iPad;FBSN/iPhone OS;FBSV/4.3;FBSS/1; FBCR/;FBID/tablet;FBLC/en_US]'
ua_asus    = 'Mozilla/5.0 (Linux; Android 8.1.0; ASUS_X01BDA Build/OPM1; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/97.0.4692.98 Mobile Safari/537.36 YJApp-ANDROID jp.co.yahoo.android.ybrowser/3.18.0.4'
ua_infinix = 'Mozilla/5.0 (Linux; Android 7.0; Infinix HOT 4 Build/NRD90M; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/88.0.4324.152 Mobile Safari/537.36 [FB_IAB/MESSENGER;FBAV/114.0.0.21.71;]'
ua_huawei  = 'Mozilla/5.0 (Linux; Android 10; VOG-L29 Build/HUAWEIVOG-L29; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/109.0.5414.117 Mobile Safari/537.36 [FB_IAB/FB4A;FBAV/401.0.0.24.77;]'
...
def login():
    ...
    print('%s[%s•%s] %shttps://business.facebook.com/business_locations'%(M,P,M,H))
    print('%s[%s•%s] %sLalu Masukkan Kode Autentikasi'%(M,P,M,P))
    cookie = str(input('\n%s[%s•%s] %sMasukkan Cookies %s: %s'%(M,P,M,P,H,P)))
    try:
        token = clotox(cookie)
        coki = {'cookie':cookie}
        prox_prox()
...
def pilih_menu():
    ...
    elif dc in ['17','017','q']: gabung_sandi.append('Gaakan Bisa');not_available('Cek Opsi Akun Hasil Crack Checkpoint')
...
def scrap_useragent():
    ...
    elif dc in ['8','08','h']:   type = 'operating_platform_string/infinix'
...
def pilih_otomatis():
    ...
    elif dc in ['8','08','h']:   open('tool/useragent.json','w').write(ua_infinix)
...
def system_login():
    global sistem_login
    print('')
    tamp_metode = f"""            {H2}[{A2}1{H2}] {P2}Validate  {H2}[{A2}2{H2}] {P2}Regular  {H2}[{A2}3{H2}] {M2}Api FB"""
...
def metode_scrap_login():
    tamp_sistem = f"""            {H2}[{A2}1{H2}] {U2}Free FB   {H2}[{A2}2{H2}] {P2}Mbasic   {H2}[{A2}3{H2}] {P2}Mobile"""
...
def metode_scrap_api():
    global sistem_login
    tamp_sistem = f"""            {H2}[{A2}1{H2}] {M2}Api 1     {H2}[{A2}2{H2}] {M2}Api 2    {H2}[{A2}3{H2}] {M2}Graph"""
    printer(Panel(tamp_sistem,title=f'{H2}[ {P2}Login {H2}]',width=54,title_align='left',style='#00FF00'))
    ch = input('   %s└──> %s'%(A,H))
...
def urut_crack():
    global urutan_crack
    tamp_urutan = f"""            {H2}[{A2}1{H2}] {M2}ID Tua    {H2}[{A2}2{H2}] {P2}ID Muda  {H2}[{A2}3{H2}] {H2}ID Acak"""
...
def pilihan_sakdurunge_crack():
    ...
    print('   %s[%s•%s] %sCek APK Akun %sOK %s?'%(O,P,O,P,H,P))
    ...
    print('   %s[%s•%s] %sGunakan %sProxy %s?'%(H,P,H,P,O,P))
